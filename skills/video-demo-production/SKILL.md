...
description: Produce a short proof-first demo-video plan for a software project. Use when the user asks to create, improve, script, structure, or review a project demo video, walkthrough clip, README GIF, product recording, or proof-first showcase for a repository. The output must be grounded in repository evidence and optimized for first-pass reviewer clarity.
---
